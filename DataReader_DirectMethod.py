...
class LeitorDados: 
    def ler_dados(arq):
        #arq = open('/home/joao/Área de Trabalho/Python/FluxoNewton/ex5.2.txt', 'r')
        texto = arq.readlines()
        arq.close()
        b = []
        c = []
        ...
        for i in range(len(texto)):
            ...
            if aux == 0:                                   #------ Dados de Barra ------- append - add um elemento no final da lista
                ...
                a.append(texto[i][56:62])                  # Potencia Ativa consumida
                a.append(texto[i][62:67])                  # Potencia Reativa consumida
                a.append(texto[i][67:72])                  # Shunt da barra
                b.append(a[:])
        ...
        DadosBarra = {'num': None,'tipo':None,'tensao':None,'angulo':None,'Pger':None,'Qger': None,'Qmin_ger':None,'Qmax_ger':None,'Pcarga':None,'Qcarga':None,'Qshunt': None}
        cont1 = 0
        ...
        for k in range(len(DadosBarra['num'])):
            DadosBarra['num'][k] = DadosBarra['num'][k]-1

        #print(DadosBarra['tipo'])
        #print('-='*100)
        #print(DadosBarra['Qcarga'])
        ...
        for k in range(len(DadosLinhas['De'])):                        
            DadosLinhas['De'][k] = int(DadosLinhas['De'][k])
            DadosLinhas['Para'][k] = int(DadosLinhas['Para'][k])
        ...
        temp5 = []
        for i in range(nb):
            DadosBarra['tensao'][i] = DadosBarra['tensao'][i]
        ...
        #print('--'*30)
        #print(B)
        return[DadosBarra,DadosLinhas,barra,Sbase,nb,nl,ramo, ntd, ntn]